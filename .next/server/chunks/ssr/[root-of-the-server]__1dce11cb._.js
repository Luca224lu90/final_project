...
"[project]/app/lib/storage.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/lib/engine.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function applyEffects(ch, effects = {}) {
    ...
    for (const k of Object.keys(stats))next.stats[k] = clampStat((next.stats[k] ?? 0) + stats[k]);
    if (typeof stress === "number") next.stress = clampStat((next.stress ?? 0) + stress);
    if (typeof motivation === "number") next.motivation = clampStat((next.motivation ?? 0) + motivation);
    if (typeof week === "number" && week !== 0) next.week = (next.week ?? 1) + week;
    return next;
}
...
"[project]/app/game/page.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$storage$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/storage.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$engine$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/engine.js [app-ssr] (ecmascript)");
...
function GamePage() {
    ...
    const [ch, setCh] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [idx, setIdx] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>Math.floor(Math.random() * __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$events$2e$json__$28$json$29$__["default"].length));
    const [resultNote, setResultNote] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null); // zum Anzeigen des Testergebnisses/Nachricht
    const current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$events$2e$json__$28$json$29$__["default"][idx], [
        idx
    ]);
    // Charakter laden
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const c = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$storage$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loadCharacter"])() || (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$storage$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ensureCharacter"])();
        setCh(c);
    }, []);
    ...
    if (!ch) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "card",
    ...
    function onChoice(choice) {
        ...
        if (choice.requires) {
            const res = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$engine$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["runRequirement"])(ch, choice.requires);
            ...
            updated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$engine$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["applyEffects"])(updated, passed ? choice.successEffects : choice.failEffects);
        } else {
            updated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$engine$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["applyEffects"])(updated, choice.effects);
        }
        // Fortschritt der Woche sichern (+1 falls nicht im Effekt enthalten)
        if (!choice.effects?.week && !choice.successEffects?.week && !choice.failEffects?.week) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$storage$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveCharacter"])(updated);
        setCh(updated);
    ...
    // Stärkstes Fach
    const topSubject = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$engine$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["bestKey"])(ch.stats);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: current.choices.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: ()=>onChoice(c),
                                children: c.label
                            }, c.id, false, {
                                fileName: "[project]/app/game/page.jsx",
                    ...
                    resultNote && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "card",
                        style: {
                            marginTop: ".8rem"
                        },
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                ...
                                children: resultNote.details.map((d, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                        children: d.type === "stat" ? `Statusprüfung: ${d.key} = ${d.value} → Ziel ${d.target} → ${d.ok ? "Bestanden" : "Nicht bestanden"}` : `Wurf (${d.dice}) = ${d.value} → Ziel ${d.target} → ${d.ok ? "Bestanden" : "Nicht bestanden"}`
                                    }, i, false, {
                                        fileName: "[project]/app/game/page.jsx",
                                        lineNumber: 150,
                                        columnNumber: 17
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1dce11cb._.js.map